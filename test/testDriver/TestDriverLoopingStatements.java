...
public class TestDriverLoopingStatements {
	@Test
	void test() throws IOException, CheckstyleException {
		// Setup
		DetailAST ast = JavaParser.parse(TestDriverUtils.GetFileContents("test/testFile/", "LoopingStatementTest.java"));
		...
		double result = check.getLoopingStatements();
		
		// Assertions
		System.out.println("Results posted: "+result);
		assertTrue(3 == result);
		System.out.println("Looping-statements check black-box test finished!");
	}
